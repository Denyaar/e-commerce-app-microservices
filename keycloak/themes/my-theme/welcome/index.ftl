...
<html>
<head>
    <title>Ecocash Authorisation Services</title>
    ...
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
            <div class="welcome-header">
                <img src="${resourcesPath}/ecocash-logo.png" alt="${productName}" border="0" />
                <h1>Welcome to <strong>Ecocash Authorisation Services</strong></h1>
            </div>
            <div class="row">
        ...
        <#if properties.displayCommunityLinks = "true">
          ...
          <div class="card-pf h-m">
            ...
            <div class='footer'>
                <#if properties.displayCommunityLinks = "true">
                    <div>© Ecocash PVT LTD All rights reserved.</div>
                </#if>
            </div>
        </div>
    </div>
